...
<base href="http://localhost:8080/ProjectISC/admin/production/"
	target="_blank">
...
<body class="nav-md" ng-app="myApp" ng-controller="adminController">
	<div class="container body">
		<div class="main_container">
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="indexx.html" class="site_title"><i class="fa fa-paw"></i>
