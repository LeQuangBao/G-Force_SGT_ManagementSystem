app.controller('entranceExamCtrl', function($scope, $http, $filter, $resource) {
	...
	function getAllEntranceExam() {
		$scope.list = [];
		$http.get(baseUrl + "/admin/api/entrance-exam").then(function(response) {
	...
	function getAllIntake(){
		$scope.listIntake = [];
		$http.get(baseUrl + "/api/intake").then(function(response) {
	...
	$scope.add = function add(close) {
		if(nameduplicate_Add($scope.exam.entranceExamName)){
			$http({
				method : "POST",
				url : baseUrl + "/admin/api/entrance-exam",
				data : $scope.exam
...
//				})
		$http({
			method : "DELETE",
			url : baseUrl + "/admin/api/entrance-exam/" + $scope.exam.id
	...
	$scope.getStudents = function getStudent(id) {
		$http({
			method : "GET",
			url : baseUrl + "/admin/api/entrance-exam/get-students/" + id
