app.controller('studentCtrl', function($scope, $http, $filter, $resource) {
    ...
    function GetListStudent() {
        ...
        var Student = $resource(baseUrl + '/admin/api/Student');
    ...
    function GetListIntake() {
        $scope.list_intake = [];
        var Intake = $resource(baseUrl + '/admin/api/StudentIntake');
    ...
    function GetListspecialization() {
        ...
        var Specialization = $resource(baseUrl + '/admin/api/StudentSpecialization');
    ...
    function GetListschool() {
        $scope.list_school = [];
        var School = $resource(baseUrl + '/admin/api/StudentSchool');
    ...
    function GetListentrance_Exam() {
        ...
        var entranceExam = $resource(baseUrl + '/admin/api/StudentEntranceExam');
...
//    	$scope.listIntakeForFilter.push(intakeAll);
    ...
    $scope.reset = function(data) {
        ...
        $http({
            method: "PUT",
            url: baseUrl + "/admin/api/Student_Reset",
    ...
    $scope.deleteStudent = function xoa() {
        ...
        $http({
            method: "DELETE",
            url: baseUrl + "/admin/api/Student/" + $scope.list_temp_inf_delete.id
    ...
    $scope.sua = function(data) {
        $http.get(baseUrl + "/admin/api/Student/" + data.id)
